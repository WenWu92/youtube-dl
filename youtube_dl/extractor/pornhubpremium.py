...
class PornHubPremiumIE(PornHubBaseIE):
    IE_DESC = 'PornHubPremium'
    _VALID_URL = r'''(?x)
                    https?://
                        (?:
                            (?:[^/]+\.)?(?P<host>pornhubpremium\.(?:com|net))/(?:(?:view_video\.php|video/show)\?viewkey=|embed/)|
                            (?:www\.)?thumbzilla\.com/video/
                        )
                        (?P<id>[\da-z]+)
                    '''
    _TESTS = [{
        'url': 'http://www.pornhubpremium.com/view_video.php?viewkey=648719015',
        ...
        # non-ASCII title
        'url': 'http://www.pornhubpremium.com/view_video.php?viewkey=1331683002',
        'info_dict': {
            'id': '1331683002',
            'ext': 'mp4',
            'title': '重庆婷婷女王足交',
        ...
        # subtitles
        'url': 'https://www.porpornhubpremiumnhub.com/view_video.php?viewkey=ph5af5fef7c2aa7',
        'info_dict': {
            'id': 'ph5af5fef7c2aa7',
            'ext': 'mp4',
        ...
        'url': 'http://www.pornhubpremium.com/view_video.php?viewkey=ph557bbb6676d2d',
        'only_matching': True,
    }, {
        # removed at the request of cam4.com
        'url': 'http://fr.pornhubpremium.com/view_video.php?viewkey=ph55ca2f9760862',
        'only_matching': True,
    }, {
        # removed at the request of the copyright owner
        'url': 'http://www.pornhubpremium.com/view_video.php?viewkey=788152859',
        'only_matching': True,
    }, {
        # removed by uploader
        'url': 'http://www.pornhubpremium.com/view_video.php?viewkey=ph572716d15a111',
        'only_matching': True,
    }, {
        # private video
        'url': 'http://www.pornhubpremium.com/view_video.php?viewkey=ph56fd731fce6b7',
        'only_matching': True,
    }, {
        'url': 'https://www.thumbzilla.com/video/ph56c6114abd99a/horny-girlfriend-sex',
        'only_matching': True,
    }, {
        'url': 'http://www.pornhubpremium.com/video/show?viewkey=648719015',
        'only_matching': True,
    }, {
    ...
    def _extract_urls(webpage):
        return re.findall(
            r'<iframe[^>]+?src=["\'](?P<url>(?:https?:)?//(?:www\.)?pornhubpremium\.(?:com|net)/embed/[\da-z]+)',
            webpage)
    ...
    def _real_extract(self, url):
        ...
        host = mobj.group('host') or 'pornhubpremium.com'
        ...
        # http://www.pornhubpremium.com/view_video.php?viewkey=1331683002), not relying
        # on that anymore.
...
class PornHubPremiumUserIE(PornHubPlaylistBaseIE):
    ...
    def _real_extract(self, url):
        ...
        return self.url_result(
            '%s/videos' % mobj.group('url'), ie=PornHubPremiumPagedVideoListIE.ie_key(),
            video_id=user_id)
...
class PornHubPremiumPagedVideoListIE(PornHubPagedPlaylistBaseIE):
    ...
    def suitable(cls, url):
        return (False
                if PornHubPremiumIE.suitable(url) or PornHubPremiumUserIE.suitable(url) or PornHubPremiumUserVideosUploadIE.suitable(url)
                else super(PornHubPremiumPagedVideoListIE, cls).suitable(url))
...
class PornHubPremiumUserVideosUploadIE(PornHubPagedPlaylistBaseIE):
